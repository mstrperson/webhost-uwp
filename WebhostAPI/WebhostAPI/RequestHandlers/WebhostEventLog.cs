...
namespace WebhostMySQLConnection
{
    ...
    public class WebhostEventLog : EventLog
    {
        ...
        public static WebhostEventLog APILog = new WebhostEventLog("Webhost API");
        ...
        {
            return String.Format("{0}{2}{1}", DateTime.Now.ToString("[mm/dd/yyyy HH:mm:ss]"), value, Environment.NewLine);
        }
