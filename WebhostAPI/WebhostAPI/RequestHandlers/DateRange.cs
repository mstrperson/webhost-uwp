...
namespace WebhostMySQLConnection
{
    public class DateRange:IComparable<DateRange>
    {
        ...
        public static DateTime WhenWeekendSignupsOpen
        {
            get
            {
                return ThisFriday.Date.AddHours(11).AddMinutes(30);
            }
        }

        public static bool WeekendSignupsAreOpen
        {
            get
            {
                return DateTime.Now >= WhenWeekendSignupsOpen;                
            }
        }
