...
{
    public class NewFacultyAccountLetter : Letterhead
    {
        public String FirstName { get; set; }
        public String Email { get; set; }
        public String Password { get; set; }

        public NewFacultyAccountLetter()
            : base()
        {
        ...
        {
            String htmlContent = String.Format("<p>Dear {0},</p><p>Welcome to Dublin School!  I am the account manager in the Tech Office." +
                "The Tech Office is located in the library computer lab, and we can help you with most computer issues.</p>" +
